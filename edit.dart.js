...
["edit", "package:chi/edit.dart", , T, {
  ...
  run__closure: {
    ...
    call$1: function(fs) {
      ...
      t3 = t2.fi_0.name;
      t1.toString;
      J._getFile$2$options$x(t1, t3, P.LinkedHashMap_LinkedHashMap$_literal(["create", true, "exclusive", false], null, null)).then$1(new T.run___closure(t2, this.draw_6));
    }
  },
  run___closure: {
  ...
  run____closure: {
    ...
    call$1: function(wr) {
      ...
      W.HttpRequest_request(this.fe_9.toURL(), null, "application/octet-stream", null, null, "arraybuffer", null, null).then$1(new T.run_____closure(this.draw_8));
    }
  },
  run_____closure: {
    "^": "Closure:10;draw_10",
...
//# sourceMappingURL=edit.dart.js.map

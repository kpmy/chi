...
x=P.X(null,null,null,P.KN,H.yo)
...
y=init.globalState.Q++
q=P.X(null,null,null,P.KN,H.yo)
...
this.y=P.X(null,null,null,P.KN,H.aX)
this.ch=P.X(null,null,null,P.KN,null)
...
b.push(u)
b.push(v)},
X:function(a,b,c,d,e){return H.J(new H.N5(0,null,null,null,null,null,0),[d,e])},
...
z=H.Q(document.querySelector("#root_canvas"),"$isN")
y=H.Q(document.querySelector("#via_canvas"),"$isN")
x=H.Q(document.querySelector("#img_canvas"),"$isN")
w=new T.V(null,null,null,null,null,null,P.X(null,null,null,null,null),new U.O(50,40))
$.tp=w
z.toString
w.Q=z.getContext("2d")
w=$.tp
...
jd:function(){var z=P.X(null,null,null,null,null)
z.q(0,"x",this.Q)
z.q(0,"y",this.a)
...
w=H.Q(document.querySelector("#root_name"),"$isMi").value
...
H.Q(document.querySelector("#root_name"),"$isMi").value=x
...
H.Q(document.querySelector("#pos"),"$isCp").textContent=H.d(x)+":"+H.d(z)
z=H.Q(document.querySelector("#size"),"$isCp")
y=y.r
...
I.$lazy($,"initializers","M","U",function(){return P.NZ(null,A.Qh)})

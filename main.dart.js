...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "CanvasGradient|CanvasPattern|CanvasRenderingContext2D|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
          ...
          $multibyte$2: {
            if (expectedUnits > 0) {
              do {
                ...
                if ((unit & 192) !== 128) {
                  if (t4)
                    throw H.wrapException(P.FormatException$("Bad UTF-8 encoding 0x" + C.JSInt_methods.toRadixString$1(unit, 16), null, null));
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    t1 = new F.Port(null, null, null, null, null, null, P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
    $.port = t1;
    root.toString;
    ...
    draw = new F.main_closure(root, via, img, div);
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure6(draw)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    draw.call$1(null);
  ...
  Port: {
    ...
    front$0: function() {
      ...
      while (true) {
        ...
        while (true) {
          ...
          if (!(x < t3))
            break;
          tp = t1.$index(0, new F.Tuple2(w, h));
          if (tp != null) {
            color = tp.get$col();
            t3 = this.img;
    ...
    put$3: function(x, y, col) {
      ...
      if (tp == null) {
        t2 = $.get$BLACK();
        t1.$indexSet(0, p, new F.Point(x, y, t2));
        if (col != null)
        ...
        tp.col = t1;
        this.lastPen = t1;
      } else if (J.$eq(tp.col, $.get$GREY50())) {
        t1 = $.get$GREY25();
        tp.col = t1;
        this.lastPen = t1;
      } else
    ...
    clear$2: function(_, x, y) {
      this.data.remove$1(0, new F.Tuple2(x, y));
    ...
    export$0: function() {
      ...
      ret = [];
      t1.get$values(t1).forEach$1(0, new F.Port_export_closure(ret));
    ...
    import$1: function(_, js) {
      ...
      pl = t1.$index(r, "data");
      if (pl != null)
        J.forEach$1$ax(pl, new F.Port_import_closure(this));
    },
    mapCoord$2: function(x, y) {
      ...
      if (typeof y !== "number")
        return y.$add();
      return new F.Tuple2(t1, C.JSNumber_methods._tdivFast$1(y + 1, 13));
    }
  },
  Port_export_closure: {
    "^": "Closure:26;ret_0",
  ...
  Port_import_closure: {
    "^": "Closure:27;this_0",
    call$1: function(m) {
      var p = new F.Point(0, 0, $.get$BLACK());
      p.Point$fromMap$1(m);
      this.this_0.data.$indexSet(0, new F.Tuple2(p.x, p.y), p);
    }
  },
  main_closure: {
    "^": "Closure:10;root_1,via_2,img_3,div_4",
    call$1: function(e) {
      var t1, t2, t3, t4;
      t1 = this.root_1;
      t2 = this.div_4;
  ...
  main_closure0: {
    ...
    call$1: function(e) {
      ...
      t3 = t3.get$x(t3);
      t2 = t2.get$offset(e);
      c = t1.mapCoord$2(t3, t2.get$y(t2));
      t2 = $.port;
      t3 = c.i1;
      t1 = c.i2;
      t2.via.save();
  ...
  main_closure6: {
    ...
    call$1: function(e) {
      ...
      if (fo != null && J.get$files$x(fo).length > 0) {
        ...
        t2 = window;
        t3 = fi.size;
        C.Window_methods._requestFileSystem$2(t2, 0, t3).then$1(new F.main__closure(t1, this.draw_5));
      }
    }
  },
  main__closure: {
    "^": "Closure:10;box_0,draw_6",
    call$1: function(fs) {
      var t1, t2, t3;
      P.print("get fs");
      t1 = J.get$root$x(fs);
      ...
      t3 = t2.fi_0.name;
      t1.toString;
      J._getFile$2$options$x(t1, t3, P.LinkedHashMap_LinkedHashMap$_literal(["create", true, "exclusive", false], null, null)).then$1(new F.main___closure(t2, this.draw_6));
    }
  },
  main___closure: {
    "^": "Closure:10;box_0,draw_7",
    call$1: function(fe) {
      P.print("get writer");
      J.createWriter$0$x(fe).then$1(new F.main____closure(this.box_0, this.draw_7, fe));
    }
  },
  main____closure: {
    "^": "Closure:10;box_0,draw_8,fe_9",
    call$1: function(wr) {
      P.print("writer");
      J.write$1$x(wr, this.box_0.fi_0);
      W.HttpRequest_request(this.fe_9.toURL(), null, "application/octet-stream", null, null, "arraybuffer", null, null).then$1(new F.main_____closure(this.draw_8));
    }
  },
  main_____closure: {
    "^": "Closure:10;draw_10",
    call$1: function(req) {
      var ul, js;
      P.print("read");
      ul = J.asUint8List$0$x(H.interceptedTypeCast(J.get$response$x(req), "$isByteBuffer"));
      js = new P.Utf8Decoder(false).convert$1(ul);
      $.port.import$1(0, js);
...
J._getFile$2$options$x = function(receiver, a0, a1) {
  return J.getInterceptor$x(receiver)._getFile$2$options(receiver, a0, a1);
};
...
{func: "dynamic__Point", args: [F.Point]},

...
@CustomTag("chi-frame")
class ChiFrame extends PolymerElement with ChangeNotifier {
  ...
  @reflectable @published int get order => __$order; int __$order = 0; @reflectable set order(int value) { __$order = notifyPropertyChange(#order, __$order, value); }
  Image img;
